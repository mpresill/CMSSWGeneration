...
# with command line options: --python_filename SMP-RunIIFall17DRPremix-00331_1_cfg.py --eventcontent PREMIXRAW --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM-RAW --fileout file:SMP-RunIIFall17DRPremix-00331_0.root --pileup_input dbs:/Neutrino_E-10_gun/RunIISummer17PrePremix-MCv2_correctPU_94X_mc2017_realistic_v9-v1/GEN-SIM-DIGI-RAW --conditions 94X_mc2017_realistic_v11 --step DIGIPREMIX_S2,DATAMIX,L1,DIGI2RAW,HLT:2e34v40 --filein file:SMP-RunIIFall17wmLHEGS-00271.root --datamix PreMix --era Run2_2017 --no_exec --mc -n 100
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:SMP-RunIIFall17wmLHEGS-00271.root'),
...
process.PREMIXRAWoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:SMP-RunIIFall17DRPremix-00331_0.root'),
